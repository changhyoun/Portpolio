$(function() {
  ...
  $(window).on('scroll', function() {
    ...
    if (scrollPosition >= 100 && scrollPosition <= 500) {
        ...
        $('#section1 p:nth-of-type(1)').html("먼저 고민하고 발견하여 고객들에게<br> 기대 이상의 만족감을 선사합니다.")
   
    } else if (scrollPosition >= 501) {
    
        $('#section1 p:nth-of-type(1)').html("파트너의 성공적인 창업과<br>지속 가능한 사업을 위해 노력합니다.")
     
    } else {
   
        $('#section1 p:nth-of-type(1)').html("NELDIT<br>다양한 기술로 새로운 가치를 제공합니다.")
...
$("#section3 .content2_left img").stop().hover(
  function() {
    ...
    $('#section3 .content2_left p').stop().fadeOut(700, function() {
      $(this).html(`먼저 고민하고 발견하여<br>고객들에게 기대 이상의<br>만족감을 선사합니다.`).fadeIn(200);
    }).css({
      "position": "absolute",
      "top": "50%",
      "left": "50%",
...
$("#section3 .content2_center img").stop().hover(
  function() {
    ...
    $('#section3 .content2_center p').stop().fadeOut(700, function() {
      $(this).html(`파트너의 성공적인 창업과<br>지속 가능한 사업을 위해<br> 노력합니다.`).fadeIn(200);
    }).css({
      "position": "absolute",
      "top": "50%",
      "left": "50%",
...
$("#section3 .content2_right img").stop().hover(
  function() {
    ...
    $('#section3 .content2_right p').stop().fadeOut(700, function() {
      $(this).html(`저희는 문제를 찾고<br>해결하는 데에 주력하며<br더 나아가 좋은 서비스를 제공하기 위해<br> 최선을 다할 것입니다.`).fadeIn(200);
    }).css({
      "position": "absolute",
      "top": "50%",
      "left": "50%",
